...
<div id="article-manager" style="display: none;">
        ...
        <?php if ($selected): ?>
            <?php while ($data = mysqli_fetch_assoc($selected)): ?>
                <tr>
                    ...
                    <td>
                        <a href='#' onclick="getContent(<?php echo "'{$data['content']}','{$data['title']}','{$data['id']}'" ; ?>)">edit</a>
                    </td>
                    <td>
    ...
    <section>
        <div id="edit-article-box" style="display: block;">
            <form action="../resources/app_controls/edit.php" method="post">
                ...
                <textarea id="content-edit" name="content" cols="30" rows="10" placeholder="Topic text"></textarea>
                <select name="tags">
