...
<article class="posts" id="article2" onclick="takeArticleId(this.id)">
    <header>
        <h1>Season 1</h1>
    </header>
    <main>
...
<article class="posts" id="article3" onclick="takeArticleId(this.id)">
    <header>
        <h1>Season 5</h1>
    </header>
    <main>
...
<article class="posts" id="article4" onclick="takeArticleId(this.id)">
    <header>
        <h1>Season 5</h1>
    </header>
    <main>
